...
@Singleton
class CatalogDataSourceImpl @Inject constructor(private val context: Context) : CatalogDataSource {
    companion object {
    ...
    override fun getCatalog() = cache ?: getCatalogFromAssets().also { cache = it }
